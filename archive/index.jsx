  ...
  if (isWindow == true) {
    return (
      <main>
        <progress
          style={{ left: "-10vw" }}
          className="progress progress-primary fixed w-full opacity-70"
          value={`${scrollY}`}
          max="100"
        ></progress>
        <Navbar />
        ...
        <section className="w-full">
          <div className="w-full lg:w-1/2 lg:fixed lg:left-1/2 lg:mt-30 bg-green-400">
            <Chart />
          </div>

          <section className="w-full lg:w-1/2 m-5 ">
